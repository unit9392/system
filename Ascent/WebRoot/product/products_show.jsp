...
<script language="javascript">
 function addshop(str){
  ...
  /// alert('<%=request.getContextPath()%>/shopcart?a=add&pid='+pid);
  } 
...
%>
<td width="30%"><div align="left">|&nbsp;&nbsp;欢迎,<%=p.getUsername() %>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="<%=request.getContextPath()%>/login?a=3" class="table_t">注销</a>&nbsp;&nbsp;|</div></td>
<td width="15%"><div align="center"><a href="<%=request.getContextPath()%>/product?a=all"><img src="<%=request.getContextPath()%>\images\productslist.jpg" width="75" height="17" border="0"/></a></div></td>
