...
<%--<%}
 ...
 %>
 <td width="30%"><div align="left">|&nbsp;&nbsp;欢迎,<%=p.getUsername() %>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="<%=request.getContextPath()%>/login?a=out" class="table_t">注销</a>&nbsp;&nbsp;|</div></td>
<td width="20%"><div align="center"><a href="#">查看已分配产品</a></div></td>
...
<table width="40%" border="1" cellspacing="0" cellpadding="0" class="mars">
  <tr bgcolor="#fba661" height="30"> 
   ...
   <%
	...
	<td><div align="center"><a href="<%=request.getContextPath()%>/order?a=finditem&oid=<%=orderid %>" >查看</a></div></td>
 	<td><div align="center"><a href="<%=request.getContextPath()%>/order?a=delorder&oid=<%=orderid%>" >删除</a></div></td>
  </tr>
  <%} %> 
</table>   
